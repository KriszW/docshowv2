        ...
        public static void StartAll()
        {
            ...
            try
            {
                ...
                if(File.Exists(path))
                {
                    ...
                    string logText = $"Az összes gépet bekapcsolták ekkor: {DateTime.Now}";
                ...
                else
                {
                    ...
                    Console.WriteLine($"Nem létezik a {path} indító cmd fájl");
                }
            }
            catch(Exception)
            {
                ...
                Console.WriteLine($"Nem sikerült elindítani a {path} indító cmdt");
            }
        }
    }
}
